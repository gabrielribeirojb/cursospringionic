...
import com.webigode.cursospringionic.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException{
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "injetideias@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		
		cli1.getTelefones().addAll(Arrays.asList("27721392", "96383893"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "injetideias1@gmail.com", "39861198334", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll((Arrays.asList("92353893", "35721392")));
		cli2.addPerfil(Perfil.ADMIN);
		
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardimm", "32820091", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38770123", cli1, c2);
